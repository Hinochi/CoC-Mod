...
package classes 
{
	...
	public class MainViewManager extends BaseContent
	{
		...
		private function initializeMarkers():void {
			...
			barsDecorated = true;
			var barsToDecorate:Array = ["strBar", "touBar", "speBar", "inteBar", "libBar", "sensBar", "corBar", "HPBar", "lustBar", "fatigueBar", "hungerBar", "bladderBar", "esteemBar", "willBar", "obeyBar", "xpBar"];
		...
		//Ostensibly hides or shows the bladder bar.
		public function hideBladderBar():void {
			if (mainView.statsView.getChildByName("bladderBar") != null) {
				mainView.bladderBar.visible = false;
				mainView.bladderNum.visible = false;
				mainView.bladderText.visible = false;
				mainView.bladderDown.visible = false;
				mainView.bladderUp.visible = false;
				mainView.statsView.getChildByName("bladderBarTrim").visible = false;
			}
		}
		public function showBladderBar():void {
			if (mainView.statsView.getChildByName("bladderBar") != null) {
				mainView.bladderBar.visible = true;
				mainView.bladderNum.visible = true;
				mainView.bladderText.visible = true;
				//mainView.hungerDown.visible = false;
				//mainView.hungerUp.visible = false;
				mainView.statsView.getChildByName("bladderBarTrim").visible = true;
			}
		}
		...
		public function setTheme():void {
			...
			if (!arraySet) {
				...
				colorableTexts.push(
					...
					mainView.bladderText, mainView.bladderNum,
					//Prison stats
		...
		public function refreshStats():void {
			...
			//Bladder bar
			mainView.bladderBar.width = (player.bladder * (baseWidth / 100));
			//Experience bar.
			if (!prison.inPrison) {
