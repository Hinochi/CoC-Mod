package classes 
{
	...
	{	
		...
		public function displayStats():void {
			...
			{
				bodyStats += "<b>Bladder:</b> " + Math.floor(player.bladder) + " / 100 (";
				if (player.bladder <= 0) bodyStats += "<font color=\"#ff0000\">Empty</font>";
				if (player.bladder > 0 && player.bladder < 10) bodyStats += "<font color=\"#C00000\">Just fine</font>";
				if (player.bladder >= 10 && player.bladder < 25) bodyStats += "<font color=\"#800000\">Not bad</font>";
				if (player.bladder >= 25 && player.bladder < 50) bodyStats += "Meh";
				if (player.bladder >= 50 && player.bladder < 75) bodyStats += "Gotta go";
				if (player.bladder >= 75 && player.bladder < 90) bodyStats += "<font color=\"#008000\">Desparate</font>";
				if (player.bladder >= 90 && player.bladder < 100) bodyStats += "<font color=\"#00C000\">Bursting</font>";
				if (player.bladder >= 100) bodyStats += "<font color=\"#00C000\">Leaking</font>";
				bodyStats += ")\n";
			}
