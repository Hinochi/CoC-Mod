...
private function campActions():void {
	...
	addButton(10, "Bathroom", useBathroom, null, null, null, "Use the bathroom");
	addButton(14, "Back", playerMenu);
}
private function useBathroom():void {
	outputText("You realize it's been some time since you last used the bathroom.", false);
	if (flags[kFLAGS.CAMP_BATHROOM] > 0) addButton(1, "Use", null, null, null, null, "I can't make this any clearer", "Pee");
	{
		outputText("You head towards the outhouse quickly, surprised you've been able to hold it this long.", false);
		outputText("As you enter the small shack of building the scent of excrement drifts up from the hole in front of you. You resolve to be quick about doing your business.", false);
	}
	if (flags[kFLAGS.CAMP_BATHROOM] < 1) addButton(2, "Hold it", null, null, null, null, "Attempt to hold it in.", "Hold it in");
	var playerWetOrDry:Number = rand(2);
	if (rand(2) > 1)
	{
		outputText("After a brief struggle to contain the impending flow, you go about your business as normal.");
	}
	if (rand(2) < 2)
	{
		outputText("Your efforts to hold on are futile. As you dance desparately on the spot to keep from having an accident, you bladder lets loose its golden bounty, wetting your [armor]."); 
	}
